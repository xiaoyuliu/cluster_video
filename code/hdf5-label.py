...
pathlabel = 'list_frm-2labelvect.txt'
...
with open(os.path.join(data_root, 'list_frm-2labelvect-random.txt'), 'w') as ouf:
	for p in path_random:
		ouf.write(p[0]+' 0\n')

train_filename = os.path.join(data_root, 'train_labelvect2.h5')
test_filename  = os.path.join(data_root, 'test_labelvect2.h5')
...
with open(os.path.join(data_root, 'train_label_2.txt'), 'w') as f:
    f.write(train_filename + '\n')
with open(os.path.join(data_root, 'test_label_2.txt'), 'w') as vf:
